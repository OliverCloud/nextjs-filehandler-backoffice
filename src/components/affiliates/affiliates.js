...
const Affiliates = () => {
    ...
    useEffect(() => {
        ...
        } else if ( windowDimensions.innerWidth > 768 && windowDimensions.innerWidth < 1024 ) {
        ...
        <div className={`${styles.container} `}>
            ...
            <div className={`${styles.slider}`}>
                <swiper-container
                    ...
                    return  <swiper-slide key={affiliate._id}>
                        <div className={styles.affiliate}>
                            <Image src={affiliate.imagePath} alt="affiliates" width={160} height={72} />
                        </div>
                    </swiper-slide>  
